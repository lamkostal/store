<template>
  <div>
    <transition name="fade">
      <div class="demo-banner" v-if="!isClosed">
        <span
          >This is a headless e-commerce website demo using vue.js & snipcart
        </span>
    ...
    <div
      ...
      data-api-key="NmZmYmY2NDgtMGFmOC00NmYwLWE2YzQtZGNiYTY0NjRlYTUxNjM3NDE4MTkyODk2MzAyOTA4"
      hidden
    ></div>
    <Footer />
  </div>
  ...
  computed: {
    pageName() {
      return this.$route.path === "/"
        ? "Lamstore - shop t-shirts and other apparel"
...
.snipcart__box--badge-highlight {
  background: linear-gradient(90deg, var(--sec-color), var(--main-color));
}
